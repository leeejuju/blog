---
title: "Building Effective Agents — 阅读笔记"
...
![High level architecture of advanced research](/images/high-level-architecture-advanced-research.png)
...
![Multi-agent system process diagram](/images/multi-agent-system-process-diagram.png)
